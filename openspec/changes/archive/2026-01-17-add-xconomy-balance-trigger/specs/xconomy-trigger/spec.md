# XConomy Trigger Module

Real-time balance monitoring and dynamic command execution based on XConomy economy plugin.
...
xconomy-trigger:
  ...
  low-balance:
    ...
    threshold: 1000.0
    commands:
      - "say %player% balance is low: %balance%"
  high-balance:
    enabled: true
    threshold: 100000.0
    commands:
      - "say %player% balance is high: %balance%"
```
